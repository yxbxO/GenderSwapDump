...
//				{
//					LOG("\n\t\t[+] TO UNLOCK :  GXT = %s, COMPOENT TYPE = %s, DLC = %s", t.m_textlabel, t.comp, t.DLC_name);
//					LOG("\t\t[-] BUY ON FEMALE :  GXT = %s, COMPOENT TYPE = %s, DLC = %s", m.m_textlabel, m.comp, m.DLC_name);
...
//				{
//					LOG("\n\t\t[+] TO UNLOCK :  GXT = %s, COMPOENT TYPE = %s, DLC = %s", t.m_textlabel, t.comp, t.DLC_name);
//					LOG("\t\t[-] BUY ON MALE :  GXT = %s, COMPOENT TYPE = %s, DLC = %s", m.m_textlabel, m.comp, m.DLC_name);
//
//					//std::cout << "\n[+] TO UNLOCK: " << t.m_key << " " << t.m_textlabel << " " << t.m_Gender << " " << t.value << std::endl;
